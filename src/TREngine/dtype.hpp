...
namespace instant {
    ...
    enum class dtype_t {//onnx::TensorProto_DataType
    ...
    inline instant::dtype_t tensor_proto_data_type_to_dtype_t(onnx::TensorProto_DataType d) {
		return static_cast<instant::dtype_t>(d);
	}

    inline int dtype_t_to_tensor_proto_data_type(dtype_t d) {
